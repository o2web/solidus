...
orders[0].line_items.create!(
  :variant => Spree::Product.with_translations(I18n.default_locale).find_by_name!("Ruby on Rails Tote").master,
  :quantity => 1,
  :price => 15.99)

orders[1].line_items.create!(
  :variant => Spree::Product.with_translations(I18n.default_locale).find_by_name!("Ruby on Rails Bag").master,
  :quantity => 1,
  :price => 22.99)
